...
const work: Position[] = [
  ...
  },
  {
    ...
    endDate: '2021-08-01',
    summary: `Resolved 30+ daily technical issues for AWS-connected devices maintaining 95% customer satisfaction rating. Documented 200+ solutions in knowledge base; collaborated with engineering teams on bug escalation.`,
    highlights: [
